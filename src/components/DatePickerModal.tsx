...
/**
 * Standalone calendar modal. Wraps DatePickerCalendar in its own
 * native Modal — use this when the calendar is the only picker on
 * screen (i.e. NOT nested inside another Modal such as
 * DateTimePickerModal, which renders DatePickerCalendar directly to
 * avoid stacking two native Modal windows).
 */
...
//   // Without this, if minDate arrives with a non-zero time component (e.g. the
//   // current moment), today's date cells are considered "past" and get disabled.
